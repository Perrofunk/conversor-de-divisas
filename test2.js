let div1 = prompt("Divisa a convertir");
let div2 = prompt("Divisa");
let can = parseFloat(prompt("Cantidad"));
...
function funcion(div1, div2, can){
    ...
    case 2:
        return "Hubo un error, escribe la divisa a la que quieres convertir nuevamente";
    case 3:
